...
-- 2) Helper: ensure caller is admin
...
-- 3) Admin "who am I" check (cheap guard)
...
-- 4) Overview analytics (last N days)
...
BEGIN
  -- admin gate
  SELECT public._assert_admin() INTO _ignore;
...
-- 5) Users list (search + pagination)
...
-- 6) Toolkits list (global, search by company/title)
